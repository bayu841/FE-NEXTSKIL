<template>
    <footer class="bg-gray-800 text-gray-300 font-poppins ">
  <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
    
    <!-- Logo & Deskripsi -->
    <div>
      <h2 class="text-white text-xl font-bold mb-4">NextSkill</h2>
      <p class="text-sm text-gray-400">
        Platform pembelajaran online untuk membantu kamu belajar coding dengan mudah, cepat, dan menyenangkan.
      </p>
    </div>
      ...
      <div class="flex space-x-4">
        ...
        <a href="#" class="hover:text-white transition">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M22 12a10 10 0 1 0-11.5 9.9v-7h-3v-3h3v-2.3c0-3 1.8-4.7 4.6-4.7 1.3 0 2.7.2 2.7.2v3h-1.5c-1.5 0-2 .9-2 1.9V12h3.4l-.5 3h-2.9v7A10 10 0 0 0 22 12z"/>
          </svg>
        </a>
        ...
        <a href="#" class="hover:text-white transition">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M6.94 6.5a1.94 1.94 0 1 1 0-3.88 1.94 1.94 0 0 1 0 3.88zM4.5 8h5v12h-5zM14.5 8h4.7v1.7h.1c.7-1.3 2.4-2.7 4.9-2.7 5.2 0 6.2 3.4 6.2 7.8V20h-5v-6.2c0-1.5 0-3.3-2-3.3s-2.3 1.6-2.3 3.2V20h-5z"/>
          </svg>
        </a>
