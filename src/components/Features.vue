...
<template>
  ...
  <section class="text-center px-6 mb-16">
    ...
    <!-- GRID -->
    <div
      class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto font-poppins"
    >
      <!-- CARD 1 -->
      <div
        class="p-6 bg-gray-50 rounded-xl text-center shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100"
      >
        <div
          class="w-12 h-12 flex items-center justify-center rounded-full bg-blue-100 mx-auto mb-4"
        >
      ...
      >
        ...
        <h3 class="font-semibold text-lg mb-2 text-gray-800">Belajar Cepat</h3>
        <p class="text-gray-500 text-sm">
      ...
      >
        ...
        <h3 class="font-semibold text-lg mb-2 text-gray-800">Fokus Skill</h3>
        <p class="text-gray-500 text-sm">
      ...
      >
        ...
        <h3 class="font-semibold text-lg mb-2 text-gray-800">Sertifikat</h3>
        <p class="text-gray-500 text-sm">
